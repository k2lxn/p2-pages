/**
 * Created by cmitguard on 4/14/16.
 */
/**
 ...
 */
function postToCartoDB(location,displayname,city,description,latitude,longitude) {
     ...
     */
    var query = "INSERT INTO mpgc_userdata(location,displayname,city,description,the_geom) VALUES('"+location+"','"+displayname+"','"+city+"','"+description+"',"+loc+")";
