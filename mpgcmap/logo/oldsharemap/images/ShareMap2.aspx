...
<%@ Register Src="~/Controls/MapViewControl2.ascx" TagName="MapViewControl" TagPrefix="uc" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div id="content" class="content full">
        <div class="containerbt">
            <div class="rowbt">
                <div class="col-md-9">
                    <h3 class="title" style="font-size: 24px;"><span id="bff">Search the Map!</span></h3>
                    <p>
                       Please use our search feature to find your pollinator location. If you are unable to find your pollinator location please click <a href="mailto:info@pollinator.org">here</a> to send a support email to our team
                    </p>
