...
$(document).ready(function() {
    ...
    $('#org_list').DataTable( {
        "ajax": {
            url: "https://massimpact.cartodb.com/api/v2/sql?q=SELECT state_province, COUNT(*) AS "num_states" FROM mpgc_database_nov WHERE ref_organization ilike 'Daughters of the American Revolution' GROUP BY state_province ORDER BY state_province ASC",
            type: "GET",
            dataSrc: "rows"
        },
        "columns": [
