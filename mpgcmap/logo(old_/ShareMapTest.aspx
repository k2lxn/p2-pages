    ...
    <div id="content" class="content full">
        <div class="containerbt">
            ...
            <div class="superrow" style="font-family: 'Dosis', sans-serif;" align="center">
                    <h2>Search Pollinators Near You!</h2>
                    <br>
                    <div class="thumbnails">
                        <img onclick="location.href='/nationalwildlifefederation';" name="img1" src="images/logo/nwf.jpg" alt=""/>
                        <img onclick="location.href='/captainplanet';" name="img1" src="images/logo/cpl.png" alt=""/>
                        <img onclick="location.href='/davidsuzukifoundation';" name="img1" src="images/logo/suzuki.png" alt=""/>
                        <img onclick="location.href='/APGA';" name="img1" src="images/logo/APGALogo.jpg" alt=""/>
                        <img onclick="location.href='/beebufferproject';" name="img1" src="images/logo/beebuffer.png" alt=""/>
                        <img onclick="location.href='/monarchjointventure';" name="img1" src="images/logo/monarchjoint.png" alt=""/>
                    </div>
                    <br>
                    <div class="thumbnails">
                        <img onclick="location.href='/WilldlifeHabitatCouncil';" name="img1" src="images/logo/wlhc.png" alt=""/>
                        <img onclick="location.href='/beefriendlyfarmer';" name="img1" src="images/logo/bff.png" alt=""/>
                        <img onclick="location.href='/ShareMap2';" name="img1" src="images/logo/tile.png" alt=""/>
                    </div>
