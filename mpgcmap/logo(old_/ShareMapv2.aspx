...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div id="content" class="content full">
        <div class="containerbt">
            ...
            <div class="row" style="padding-bottom:35px; padding-top:100px">
                <iframe src="http://mitguard.com/pollinator/map15v1.html" style="width:100%; height: 550px"></iframe>
            </div>
        </div>
            <div class="superrow" style="font-family: 'Dosis', sans-serif;" align="center">
                    ...
                    <div class="thumbnails">
                        <img onclick="location.href='http://google.com';" name="img1" src="images/logo/american.jpg" alt=""/>
                        <img onclick="preview.src=img2.src" name="img2" src="images/logo/NWF.jpg" alt="National Wildlife Association"/>
                        <img onclick="preview.src=img3.src" name="img3" src="images/logo/cpl.png" alt=""/>
                        <img onclick="preview.src=img4.src" name="img4" src="images/test/img4.jpg" alt=""/>
                        <img onclick="preview.src=img5.src" name="img5" src="images/test/img5.jpg" alt=""/>
                        <img onclick="preview.src=img5.src" name="img5" src="images/test/img5.jpg" alt=""/>
                    </div>
